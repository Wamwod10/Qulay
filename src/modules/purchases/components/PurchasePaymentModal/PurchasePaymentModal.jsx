...
const PurchasePaymentModal = ({ open, purchase, onClose, onSubmit }) => {
  ...
  const handleSubmit = () => {
    if (paid < 0) {
      setError("To‘lov manfiy bo‘lishi mumkin emas.");

      return;
    }

    if (paid > total) {
      setError("To‘lov jami summadan katta bo‘lishi mumkin emas.");
