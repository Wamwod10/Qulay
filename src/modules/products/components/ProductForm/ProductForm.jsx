...
const toFormValues = (initialValues) => {
  ...
  return {
    ...
    expiryDate: initialValues.expiryDate
      ? String(initialValues.expiryDate).slice(0, 10)
      : "",
...
const ProductForm = ({
  ...
  const handleSubmit = (event) => {
    ...
    const product = {
      ...
      normalWastePercent:
        form.normalWastePercent === "" ? null : Number(form.normalWastePercent),
      cost: Number(form.cost) || 0,
      salePrice:
        form.type === "RAW_MATERIAL" || form.salePrice === ""
          ? null
    ...
    <form className="product-form" onSubmit={handleSubmit}>
      ...
      <section className="product-form__section">
        <div className="product-form__section-header">
          ...
          <p>
            {translateText(
              "Mahsulotni tezroq tanish uchun rasm qo'shishingiz mumkin.",
            )}
          </p>
        </div>
        ...
        <div className="product-form__image-area">
          <div className="product-form__image-preview">
            {form.image ? (
              <img
                src={form.image}
                alt={form.name || translateText("Mahsulot")}
              />
            ) : (
      ...
      <section className="product-form__section">
        <div className="product-form__section-header">
          ...
          <p>
            {translateText(
              "Mahsulotning nomi, turi, kategoriya va identifikatsiyasi.",
            )}
          </p>
        </div>
      ...
      <section className="product-form__section">
        <div className="product-form__section-header">
          ...
          <p>
            {translateText(
              "Mahsulotning boshlang'ich va minimal qoldiq chegarasi.",
            )}
          </p>
        </div>
        ...
        <div className="product-form__grid">
          ...
          <Input
            ...
            onChange={(event) =>
              handleChange("reorderPoint", event.target.value)
            }
          />
          ...
          <Input
            ...
            onChange={(event) =>
              handleChange("normalWastePercent", event.target.value)
            }
          />
        </div>
      </section>
      ...
      <section className="product-form__section">
        <div className="product-form__section-header">
          ...
          <p>
            {translateText(
              "Tannarx, sotuv narxi, QQS va chegirmani belgilang.",
            )}
          </p>
        </div>
      ...
      <section className="product-form__section">
        <div className="product-form__section-header">
          ...
          <p>
            {translateText(
              "Mahsulot bo'yicha ichki izoh yoki muhim eslatmalar.",
            )}
          </p>
        </div>
      ...
      <div className="product-form__status">
        <Switch
          ...
          description={translateText(
            "Faol mahsulot savdo, ombor va ishlab chiqarish jarayonlarida ishlatilishi mumkin.",
          )}
